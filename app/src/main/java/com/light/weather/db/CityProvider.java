...
import static com.light.weather.db.CityProvider.CityDatabaseHelper.CITY_TABLE_NAME;


public class CityProvider extends ContentProvider {
    public static final String AUTHORITY = "com.light.weather.City";// 授权
    ...
    private static final int CITIES = 1;// 多个城市查询
    private static final int CITY_ID = 2;// 单个城市查询

    static {
        URI_MATCHER.addURI(AUTHORITY, "city", CITIES);
    ...
    static class CityDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE table IF NOT EXISTS "
                    ...
                    + CityConstants.WEATHER_NAME + " TEXT, "
                    + CityConstants.WEATHER_CODE + " TEXT, "
                    + CityConstants.WEATHER_TEMPERATURE + " TEXT, "
    ...
    public static final class CityConstants implements BaseColumns {
        ...
        public static final String WEATHER_NAME = "codeTxt";
        public static final String WEATHER_CODE = "code";
        public static final String WEATHER_TEMPERATURE = "tmp";
        ...
        public static String[] getCityDefaultProjection() {
            return new String[]{CITY, COUNTRY, AREA_ID, LATITUDE, LONGITUDE, PROVINCE,
                    IS_LOCATION, ORDER_INDEX, WEATHER_NAME, WEATHER_CODE, WEATHER_TEMPERATURE};
        }
    }
}
